  ...
  return (
    <div className='relative'>
      ...
      <Dropdown
        ...
        className=' dark:bg-gray-dark absolute -right-[240px] mt-[16px] flex h-[480px] w-[350px] flex-col rounded-2xl border border-gray-200 bg-white p-3 sm:w-[361px] lg:right-0 dark:border-gray-800'
      >
